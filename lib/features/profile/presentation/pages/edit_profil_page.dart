...
class _EditProfilPageState extends State<EditProfilPage> {
  ...
  // update profile button pressed fonction
  void updateProfile() async {
    ...
    // only update profile if there is comething to update 
    if(imagePickedFile != null || newBio != null){
      profileCubit.updateProfile(
        uid: uid, 
        newBio: newBio,
        imageMoblilePath: imageMobilePath,
        imageWebBytes: imageWebBytes,
      );
    }

    // nothing to update -> go to the previous page
    else {
